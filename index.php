					...
					<div class="row 150%">
						...
						<div class="4u$ 12u$(medium)">
							<section class="box">
								...
								<h3>Write Reviews</h3>
								<p>Help out your friends by giving them pointers about any course.(Also you can criticize your profs) It's a free society after all :p</p>
							</section>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row">
						<div class="8u 12u$(medium)">
							<ul class="copyright">
								<li>&copy; Saketh & Junaid. No rights reserved.</li>
								<li>Images: <a href="https://wwwgoogle.com/imghp">Isn't Google enough?</a></li>
							</ul>
						</div>
						<div class="4u$ 12u$(medium)">
							<ul class="icons">
